    ...
    <div className="max-w-4xl">
      <div className="mb-6">
        ...
        <p className="text-sm text-slate-500 mt-0.5">
          {pending > 0 ? (
            <span className="font-semibold text-amber-600">{pending} en attente</span>
          ) : (
      ...
      <div className="flex flex-col gap-3">
        ...
        {demandes.map((d) => {
          ...
          return (
            <div
              key={d.id}
              className={`bg-white rounded-2xl border shadow-sm p-5 flex flex-col sm:flex-row gap-4 sm:items-start ${
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1 flex-wrap">
                  ...
                  {d.clientes && (
                    <span className="text-xs text-slate-400">
                      (cliente : {d.clientes.prenom} {d.clientes.nom})
                    </span>
                  )}
                ...
                <p className="text-sm text-slate-700 mt-1.5 bg-slate-50 rounded-xl px-3 py-2">
                  🗓 {d.disponibilite_souhaitee}
                </p>
              ...
              {isPending && (
                <div className="flex gap-2 sm:flex-col shrink-0">
                  <form action={updateStatutDemandeAction}>
                    ...
                    <button className="w-full sm:w-32 px-4 py-2 text-xs font-semibold rounded-xl bg-emerald-600 text-white hover:bg-emerald-700 transition-colors">
                      ✓ Confirmer
                    </button>
                  </form>
                  <form action={updateStatutDemandeAction}>
                    ...
                    <button className="w-full sm:w-32 px-4 py-2 text-xs font-semibold rounded-xl border border-red-200 text-red-600 hover:bg-red-50 transition-colors">
                      ✕ Refuser
                    </button>
                  </form>
                </div>
